...
export default function FooterSection() {
    return (
        <footer className="py-16 md:py-32 border-t bg-background">
            <div className="mx-auto max-w-5xl px-6">
                ...
                >
                    <Image
                        ...
                        className="rounded"
                    />
                    <span className="text-xl font-semibold tracking-tight text-foreground">Noteforge</span>
                </Link>
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    {[
                        ...
                        { href: '#', label: 'Threads', icon: ThreadsIcon },
...
// ---- ICON COMPONENTS ----
// You can extract these into a separate file or replace with lucide-react icons
